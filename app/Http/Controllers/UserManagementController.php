...
class UserManagementController extends Controller
{
    ...
    public function registerUserWithBusiness(AuthRegisterBusinessRequest $request)
    {
        ...
        try {
            ...
            return  DB::transaction(function () use (&$request) {
                ...
                $this->seedBusinessDefaults($user);
     ...
     *     description="This endpoint updates an existing user with all relevant fields.",
     *
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     *             required={"id","first_name","last_name","email","phone","address_line_1","country","city","postcode","role"},
     *             @OA\Property(property="id", type="integer", example=1),
     *             @OA\Property(property="first_name", type="string", example="Rifat"),
     *             @OA\Property(property="last_name", type="string", example="Mia"),
     *             @OA\Property(property="email", type="string", example="rifat@example.com"),
     *             @OA\Property(property="password", type="string", example="secret123"),
     *             @OA\Property(property="password_confirmation", type="string", example="secret123"),
     *             @OA\Property(property="phone", type="string", example="+8801712345678"),
     *             @OA\Property(property="address_line_1", type="string", example="House 12, Road 3"),
     *             @OA\Property(property="address_line_2", type="string", example="Dhanmondi"),
     ...
     *             @OA\Property(property="lat", type="string", example="23.7806"),
     *             @OA\Property(property="long", type="string", example="90.4074"),
    ...
    public function updateUser(UserUpdateRequest $request)
    {
        ...
        try {
            ...
            $request_data['is_active'] = true;
            $request_data['remember_token'] = Str::random(10);
            $user  =  tap(User::where(["id" => $request_data["id"]]))->update(
